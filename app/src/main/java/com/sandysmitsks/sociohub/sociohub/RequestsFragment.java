...
public class RequestsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        UsersReference = fireData.child("Users");
        FriendsDatabaseRef = fireData.child("Friends");
        FriendsReqDatabaseRef = fireData.child("Friend_Requests");
        FriendRequestReference = FriendsReqDatabaseRef.child(online_user_id);
...
//                            Toast.makeText(getActivity(), "Found:" + request_type, Toast.LENGTH_SHORT).show();
                                                                            ...
                                                                            FriendsReqDatabaseRef.child(online_user_id).child(list_users_id).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                ...
                                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                                    if (task.isSuccessful()) {
                                                                                        FriendRequestReference.child(list_users_id).child(online_user_id).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                            @Override
                                                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                                                if (task.isSuccessful()) {
    ...
    public static class RequestViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setThumb_user_image(final Context ctx, final String thumbImage) {
        ...
        public void setUser_Status(String userStatus) {
            TextView status = (TextView) mView.findViewById(R.id.requset_profile_status);
