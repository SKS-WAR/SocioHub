    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ResetPasswordSendEmailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
               ...
               {
                   Toast.makeText(ResetPasswordActivity.this,"Enter your E-mail first",Toast.LENGTH_SHORT).show();
               }
               else
               {
                   mAuth.sendPasswordResetEmail(userEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                       ...
                       public void onComplete(@NonNull Task<Void> task) {
                         ...
                         else
                         {
                             ...
                             Toast.makeText(ResetPasswordActivity.this,"Error Occured"+ msg,Toast.LENGTH_SHORT).show();
                         }
                       }
                   });
               }
