...
public class SettingsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        settingsChangeProfileImageButton = (Button) findViewById(R.id.settings_change_profile_image);
        ...
        getUserDataReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
              ...
              if (!image.equals("download")) {

                  Picasso.with(SettingsActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.download).into(settingsDisplayProfileImage, new Callback() {
                      @Override
                      ...
                      public void onError()
                      {
                          Picasso.with(SettingsActivity.this).load(image).placeholder(R.drawable.download).into(settingsDisplayProfileImage);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK)
            {
                ...
                try {
                    thumb_bitmap = new Compressor(this).setMaxHeight(200).setMaxHeight(200)
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull final Task<UploadTask.TaskSnapshot> task) {
                      ...
                      {
                          Toast.makeText(SettingsActivity.this,"Saving your Profile Picture",Toast.LENGTH_LONG).show();
                          ...
                          Toast.makeText(SettingsActivity.this,"Error occured while Uploading",Toast.LENGTH_LONG).show();
                          loadingBar.dismiss();
                      }
                    }
                });
